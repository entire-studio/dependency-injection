...
use EntireStudio\DependencyInjection\Resolver\ParameterResolver;
...
class Container implements ContainerInterface
{
    ...
    public function call(callable $callable, array $args = []): mixed
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            $resolved[] = $this->parameterResolver->resolve($param, $context);
        }
    ...
    private function resolve(string $id): object
    {
        ...
        try {
            ...
            foreach ($constructor->getParameters() as $param) {
                ...
                $dependencies[] = $this->parameterResolver->resolve($param, $id);
            }
        } finally {
